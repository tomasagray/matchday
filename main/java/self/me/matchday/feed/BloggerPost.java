...
/**
 * Represents an individual, generic post on a Blogger blog. The constructor
 * accepts either a Gson JsonObject or a JSON string.
 * 
 * This class can be extended to allow it to be customized to a particular
 * blog.
 * 
 * @author tomas
 */
public class BloggerPost
{
    ...
    // Getters
    // -------------------------------------------------------------------------
    public String getBloggerPostID() {
    ...
    /**
     * Constructs a fully-formed BloggerPost object which is then
     * passed to the BloggerPost constructor.
     *
     */
    public static class BloggerPostBuilder
    {
        ...
        private final List<String> categories = new ArrayList<>();    // will be empty if no categories parsed
        ...
        /**
         * Call each build method, to ensure a properly constructed
         * BloggerPost object is created
         *
