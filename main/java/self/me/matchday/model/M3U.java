...
public class M3U {
  ...
  private static final String PROGRAM_TIME = "#EXT-X-PROGRAM-DATE-TIME:";
  private static final String MEDIA = "#EXT-X-MEDIA:";  // for linking multiple versions; may not be used
