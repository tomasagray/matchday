...
//    private static final int ASSERT = 5;
    ...
    private static class LogEntry
    {
        ...
        private LogEntry(String tag, String msg, Instant timestamp, Level level, @Nullable Throwable throwable)
        {
            this.tag = tag;
            this.msg = msg;
        ...
        /**
         * Helper method to extract the package name of the method which sent the
         * log message. This will be the 5th element in the stack:
         *  java.lang <> getStackTrace
         *      |-self.me.matchday.util.LogEntry <> <init>
         *          |-self.me.matchday.util.Log <> <init>
         *              |-self.me.matchday.util.Log <> d
         *                  |-{THE CLASS WE WANT}
         *
    ...
    /**
     * Debug method, for logs relevant to detecting problems within
     * the application.
     *
     * @param tag An identifier for easier log sorting
     * @param msg The message to be logged
    ...
    /**
     * Warning messages; more serious than informational, less serious than
     * errors.
     *
     * @param tag Tag for sorting log output
     * @param msg The message to be logged
