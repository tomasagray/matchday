...
- IP address to ApplicationInfo

### Fixed

- Consolidated remote data retrieval
...
- FileJoker data source plugin

### Fixed

- VPN logging, argument processing

### Security

- Ensure SnapshotRequests are validated

## [0.4.6] - 2025-10-03

### Fixed

- API version (no subversion necessary)
- Duplicate competitions returned when searching by team
