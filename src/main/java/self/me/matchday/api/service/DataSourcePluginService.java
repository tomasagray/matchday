...
public class DataSourcePluginService {
  ...
  DataSourcePluginService(
      Collection<DataSourcePlugin> dataSourcePlugins, PluginService pluginService) {
  ...
  public void enablePlugin(@NotNull final UUID pluginId) {
    dataSourcePlugins.stream()
        ...
        .findFirst()
        .ifPresentOrElse(
            plugin -> pluginService.enablePlugin(plugin, ENABLED_DATASOURCES),
            () -> {
  ...
  public void disablePlugin(@NotNull final UUID pluginId) {
    dataSourcePlugins.stream()
        ...
        .findFirst()
        .ifPresentOrElse(
            plugin -> pluginService.disablePlugin(plugin, ENABLED_DATASOURCES),
            () -> {
              throw new PluginNotFoundException(
