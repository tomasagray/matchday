...
public class ScheduledTaskService {
    ...
    public void scheduleTasks() {
        ...
        scheduledTasks.put(
                ...
                taskScheduler.schedule(this::refreshEventData, refreshEvents));
        scheduledTasks.put(
                TaskType.PRUNE_VIDEOS,
                taskScheduler.schedule(this::pruneVideoData, pruneVideoData));
    }
    ...
    @Component
    public static final class SettingsUpdatedListener implements ApplicationListener<SettingsUpdatedEvent> {
