...
public class BackupServiceLog {
    ...
    @Around("execution(* self.me.matchday.api.service.admin.BackupService.createRestorePoint(..))")
    ...
    @Before("execution(* self.me.matchday.api.service.admin.BackupService.fetchAllRestorePoints(..))")
    public void logFetchAllRestorePoints() {
        logger.info("Retrieving all System Restore Points from database...");
    }

    @Around("execution(* self.me.matchday.api.service.admin.BackupService.createBackup(..))")
    ...
    @Around("execution(* self.me.matchday.api.service.admin.BackupService.restoreSystem(..))")
    ...
    @Before("execution(* self.me.matchday.api.service.admin.BackupService.loadBackupArchive(..))")
    ...
    @Before("execution(* self.me.matchday.api.service.admin.BackupService.dehydrate(..))")
    public void logDehydrateSystem() {
        logger.info("Dehydrating system...");
    }

    @Around("execution(* self.me.matchday.api.service.admin.BackupService.rehydrateFrom(..))")
