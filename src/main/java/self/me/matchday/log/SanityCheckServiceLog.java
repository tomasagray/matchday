...
public class SanityCheckServiceLog {
  ...
  @Around(
      "execution(* self.me.matchday.api.service.admin.SanityCheckService.createSanityReport(..))")
  ...
  @Around(
      "execution(* self.me.matchday.api.service.admin.SanityCheckService.createArtworkSanityReport(..))")
  ...
  @Around(
      "execution(* self.me.matchday.api.service.admin.SanityCheckService.createVideoSanityReport(..))")
  ...
  @Before(
      "execution(* self.me.matchday.api.service.admin.SanityCheckService.deleteArtworkFiles(..))")
