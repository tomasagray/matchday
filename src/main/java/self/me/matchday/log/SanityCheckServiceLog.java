...
import self.me.matchday.api.service.admin.SanityCheckService;
...
public class SanityCheckServiceLog {
    ...
    @Around("execution(* self.me.matchday.api.service.admin.SanityCheckService.createSanityReport(..))")
    ...
    @Around("execution(* self.me.matchday.api.service.admin.SanityCheckService.createArtworkSanityReport(..))")
    ...
    @Around("execution(* self.me.matchday.api.service.admin.SanityCheckService.createVideoSanityReport(..))")
    ...
    @Around("execution(* self.me.matchday.api.service.admin.SanityCheckService.autoHealSystem(..))")
    ...
    @Around("execution(* self.me.matchday.api.service.admin.SanityCheckService.autoHealArtwork(..))")
    ...
    @Before("execution(* self.me.matchday.api.service.admin.SanityCheckService.deleteArtworkFiles(..))")
    public void logDeleteDanglingArtworkFiles() {
        logger.info("Deleting dangling Artwork files...");
    }

    @Around("execution(* self.me.matchday.api.service.admin.SanityCheckService.autoHealVideos(..))")
