...
import self.me.matchday.api.service.MatchArtworkService;
...
public class MatchArtworkServiceLog {
  ...
  @Around("execution(* self.me.matchday.api.service.MatchArtworkService.makeMatchArtwork(..))")
  ...
  @Before("execution(* self.me.matchday.api.service.MatchArtworkService.readArtworkData(..))")
  public void logReadArtworkData(@NotNull JoinPoint jp) {
    logger.info("Reading image data for: {}", jp.getArgs()[0]);
  }

  @Before("execution(* self.me.matchday.api.service.MatchArtworkService.deleteArtworkFromDisk(..))")
