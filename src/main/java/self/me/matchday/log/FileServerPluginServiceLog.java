...
public class FileServerPluginServiceLog {
  ...
  @AfterReturning(
      value =
          "execution(* self.me.matchday.api.service.FileServerPluginService.getFileServerPlugins(..))",
  ...
  @AfterReturning(
      value =
          "execution(* self.me.matchday.api.service.FileServerPluginService.getEnabledPlugins(..))",
  ...
  @Around("execution(* self.me.matchday.api.service.FileServerPluginService.isPluginEnabled(..))")
  ...
  @Around("execution(* self.me.matchday.api.service.FileServerPluginService.getPluginById(..))")
  ...
  @Around("execution(* self.me.matchday.api.service.FileServerPluginService.disablePlugin(..))")
  ...
  @Around("execution(* self.me.matchday.api.service.FileServerPluginService.enablePlugin(..))")
  ...
  @SuppressWarnings("unchecked cast")
  @Around("execution(* self.me.matchday.api.service.FileServerPluginService.getDownloadUrl(..))")
  ...
  @Around(
      "execution(* self.me.matchday.api.service.FileServerPluginService.getFileServerRefreshRate(..))")
  ...
  @Around(
      "execution(* self.me.matchday.api.service.FileServerPluginService.getEnabledPluginForUrl(..))")
