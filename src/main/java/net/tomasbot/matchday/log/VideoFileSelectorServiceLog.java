...
import net.tomasbot.matchday.api.service.video.VideoFileSelectorService;
...
public class VideoFileSelectorServiceLog {
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.video.VideoFileSelectorService.getBestFileSource(..))")
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.video.VideoFileSelectorService.getPlaylistFiles(..))")
