...
public class CompetitionServiceLog {
  ...
  @Around("execution(* net.tomasbot.matchday.api.service.CompetitionService.fetchAll(..))")
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.CompetitionService.fetchCompetitionBy*(..))")
  ...
  @Around("execution(* net.tomasbot.matchday.api.service.CompetitionService.save(..))")
  ...
  @Before("execution(* net.tomasbot.matchday.api.service.CompetitionService.delete(..))")
