...
public class ArtworkServiceLog {
  ...
  @Around("execution(* net.tomasbot.matchday.api.service.ArtworkService.readArtworkData(..))")
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.ArtworkService.addArtworkToCollection(..))")
  ...
  @Before(
      "execution(* net.tomasbot.matchday.api.service.ArtworkService.repairArtworkFilePaths(..))")
  public void logRepairArtworkPath(@NotNull JoinPoint jp) {
    logger.info("Repairing Artwork file paths for collection: {}", jp.getArgs());
  }

  @Before(
      "execution(* net.tomasbot.matchday.api.service.ArtworkService.deleteArtworkFromCollection(..))")
  ...
  @Around("execution(* net.tomasbot.matchday.api.service.ArtworkService.deleteArtwork(..))")
  ...
  @Before(
      "execution(* net.tomasbot.matchday.api.service.ArtworkService.deleteArtworkCollection(..))")
