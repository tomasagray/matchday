...
public class DataSourcePluginServiceLog {
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.DataSourcePluginService.getDataSourcePlugins())")
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.DataSourcePluginService.getEnabledPlugins())")
  ...
  @Around("execution(* net.tomasbot.matchday.api.service.DataSourcePluginService.enablePlugin(..))")
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.DataSourcePluginService.disablePlugin(..))")
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.DataSourcePluginService.isPluginEnabled(..))")
  ...
  @Before(
      "execution(* net.tomasbot.matchday.api.service.DataSourcePluginService.validateDataSource(..))")
