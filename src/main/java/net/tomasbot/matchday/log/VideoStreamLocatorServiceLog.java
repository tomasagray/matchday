...
public class VideoStreamLocatorServiceLog {
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.video.VideoStreamLocatorService.getAllStreamLocators(..))")
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.video.VideoStreamLocatorService.getStreamLocator(..))")
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.video.VideoStreamLocatorService.getStreamLocatorFor(..))")
  ...
  @Before(
      "execution(* net.tomasbot.matchday.api.service.video.VideoStreamLocatorService.updateStreamLocator(..))")
  ...
  @Before(
      "execution(* net.tomasbot.matchday.api.service.video.VideoStreamLocatorService.deleteStreamLocator(..))")
