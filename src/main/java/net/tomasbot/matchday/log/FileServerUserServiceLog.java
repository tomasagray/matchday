...
public class FileServerUserServiceLog {
  ...
  @Around("execution(* net.tomasbot.matchday.api.service.FileServerUserService.login(..))")
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.FileServerUserService.loginWithCookies(..))")
  ...
  @Before(
      "execution(* net.tomasbot.matchday.api.service.FileServerUserService.setUserLoggedInToServer(..))")
  ...
  @Around("execution(* net.tomasbot.matchday.api.service.FileServerUserService.logout(..))")
  ...
  @Before("execution(* net.tomasbot.matchday.api.service.FileServerUserService.relogin(..))")
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.FileServerUserService.getAllServerUsers(..))")
  ...
  @Around("execution(* net.tomasbot.matchday.api.service.FileServerUserService.getUserById(..))")
  ...
  @Before("execution(* net.tomasbot.matchday.api.service.FileServerUserService.deleteUser(..))")
