...
public class VideoFileServiceLog {
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.video.VideoFileService.refreshVideoFile(..))")
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.video.VideoFileService.doVideoFileRefresh(..))")
