...
import net.tomasbot.matchday.api.service.video.VideoSourceService;
...
public class VideoSourceServiceLog {
  ...
  @Around("execution(* net.tomasbot.matchday.api.service.video.VideoSourceService.fetchById(..))")
