...
import net.tomasbot.matchday.api.service.SynonymService;
import net.tomasbot.matchday.model.Synonym;
...
public class SynonymServiceLog {
  ...
  @Before("execution(* net.tomasbot.matchday.api.service.SynonymService.initialize(..))")
  public void logInitializeSynonym(@NotNull JoinPoint jp) {
    logger.debug("Initializing Synonym: {}", jp.getArgs()[0]);
  }

  @Before("execution(* net.tomasbot.matchday.api.service.SynonymService.save(..))")
  public void logSaveSynonym(@NotNull JoinPoint jp) {
    logger.info("Saving Synonym: {}", jp.getArgs()[0]);
  }

  @SuppressWarnings("unchecked cast")
  @Before("execution(* net.tomasbot.matchday.api.service.SynonymService.saveAll(..))")
  ...
  @Before("execution(* net.tomasbot.matchday.api.service.SynonymService.delete(..))")
  public void logDeleteSynonym(@NotNull JoinPoint jp) {
    logger.info("Deleting Synonym with ID: {}", jp.getArgs()[0]);
  }

  @SuppressWarnings("unchecked cast")
  @Before("execution(* net.tomasbot.matchday.api.service.SynonymService.deleteAll(..))")
