...
public class VideoStreamLocatorPlaylistServiceLog {
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.video.VideoStreamLocatorPlaylistService.getAllVideoStreamPlaylists())")
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.video.VideoStreamLocatorPlaylistService.createVideoStreamPlaylist(..))")
  ...
  @Around(
      "execution(* net.tomasbot.matchday.api.service.video.VideoStreamLocatorPlaylistService.getVideoStreamPlaylistFor(..))")
  ...
  @Before(
      "execution(* net.tomasbot.matchday.api.service.video.VideoStreamLocatorPlaylistService.deleteVideoStreamPlaylist(..))")
