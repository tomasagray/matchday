...
public class MatchDataParserLog {
  ...
  @Around(
      "execution(* net.tomasbot.matchday.plugin.datasource.parsing.MatchDataParser.getStreamForType(..))")
  ...
  @Around(
      "execution(* net.tomasbot.matchday.plugin.datasource.parsing.MatchDataParser.createUrlStreams(..))")
