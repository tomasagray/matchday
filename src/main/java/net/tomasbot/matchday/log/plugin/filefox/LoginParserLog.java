...
package net.tomasbot.matchday.log.plugin.filefox;
...
import net.tomasbot.matchday.plugin.fileserver.filefox.LoginParser;
...
public class LoginParserLog {
  ...
  @Around(
      "execution(* net.tomasbot.matchday.plugin.fileserver.filefox.LoginParser.performLogin(..))")
  ...
  @Around(
      "execution(* net.tomasbot.matchday.plugin.fileserver.filefox.LoginParser.evaluateLoginResponse(..))")
  ...
  @Around(
      "execution(* net.tomasbot.matchday.plugin.fileserver.filefox.LoginParser.getLoginData(..))")
