...
import net.tomasbot.matchday.plugin.io.ffmpeg.FFmpegSingleStreamTask;
...
public class FFmpegSingleStreamTaskLog {
  ...
  @AfterReturning(
      value =
          "execution(* net.tomasbot.matchday.plugin.io.ffmpeg.FFmpegSingleStreamTask.getArguments(..))",
      returning = "args")
  ...
  @Before(
      "execution(* net.tomasbot.matchday.plugin.io.ffmpeg.FFmpegSingleStreamTask.prepareStream(..))")
  ...
  @AfterReturning(
      value =
          "execution(* net.tomasbot.matchday.plugin.io.ffmpeg.FFmpegSingleStreamTask.getInputArg(..))",
      returning = "input")
