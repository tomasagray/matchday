...
import net.tomasbot.matchday.api.service.UserValidationService;
...
public class UserValidationServiceLog {
  ...
  @Before(
      "execution(* net.tomasbot.matchday.api.service.UserValidationService.validateUserForLogin(..))")
  ...
  @Before(
      "execution(* net.tomasbot.matchday.api.service.UserValidationService.validateEmailAddress(..))")
  ...
  @Before(
      "execution(* net.tomasbot.matchday.api.service.UserValidationService.validatePassword(..))")
