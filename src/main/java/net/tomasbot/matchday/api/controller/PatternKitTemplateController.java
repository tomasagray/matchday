...
import static net.tomasbot.matchday.api.resource.PatternKitTemplateResource.TemplateResourceAssembler;

import java.util.List;
import net.tomasbot.matchday.api.resource.PatternKitTemplateResource;
