...
import net.tomasbot.matchday.api.resource.FileServerUserResource;
import net.tomasbot.matchday.api.resource.FileServerUserResource.UserResourceAssembler;
import net.tomasbot.matchday.api.service.FileServerLoginException;
import net.tomasbot.matchday.api.service.FileServerUserService;
import net.tomasbot.matchday.api.service.InvalidCookieException;
