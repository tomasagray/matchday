...
class JsonBloggerPostBuilderTest {
    ...
    static void setUp() throws IOException {
        ...
        final String postData =
                String.join("", ResourceFileReader.readTextResource(JsonBloggerPostBuilderTest.class, "zkf_post.json"));
        final JsonObject jsonObject = JsonStreamReader.readJsonString(postData);
        // Get JSON object for post
        final JsonBloggerPostBuilder postBuilder = new JsonBloggerPostBuilder(jsonObject.get("entry").getAsJsonObject());
    ...
    void testPublishDate() {
        ...
        Log.i(LOG_TAG, "Testing post publish date: " + actualPublishDate.format(DateTimeFormatter.ISO_LOCAL_DATE_TIME));
    ...
    void testLink() throws MalformedURLException {
        ...
        final String expectedLink = "http://zkfullmatchvideos.blogspot.com/2020/10/international-friendly-austria-vs.html";
    ...
    void testCategories() {
        ...
        final List<String> expectedCategories = List.of("Austria National Team", "Friendly matches", "Greece National Team");
