...
package net.tomasbot.matchday.unit.plugin.datasource.parsing.fabric;

import java.util.stream.IntStream;
import java.util.stream.Stream;
import org.jetbrains.annotations.NotNull;
import net.tomasbot.matchday.plugin.datasource.parsing.fabric.Fabric;
import net.tomasbot.matchday.unit.plugin.datasource.parsing.fabric.model.Bar;
import net.tomasbot.matchday.unit.plugin.datasource.parsing.fabric.model.Bubble;
import net.tomasbot.matchday.unit.plugin.datasource.parsing.fabric.model.Foo;
import net.tomasbot.matchday.unit.plugin.datasource.parsing.fabric.model.Marklar;
