...
import static net.tomasbot.matchday.plugin.datasource.blogger.BloggerPlugin.SourceType.HTML;
import static net.tomasbot.matchday.plugin.datasource.blogger.BloggerPlugin.SourceType.JSON;
...
import net.tomasbot.matchday.plugin.datasource.blogger.QueryBuilderService;
